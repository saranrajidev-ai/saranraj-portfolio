...
const EXPERIENCES = [
  {
    ...
    achievements: [
      "Architected Product Manager 2.0: Engineered a core full-stack MERN platform managing dynamic product configurations across 10+ major NBFC clients using modular microservices.",
      "High-Throughput Architecture: Designed and deployed a distributed inventory and leasing infrastructure for Reliance Jio AirFiber, processing 100K+ concurrent records with a 30% jump in operational efficiency.",
      "No-Code Masters System: Programmed a custom Dataset web application enabling non-technical operators to modify master data safely without code deployments, reducing engineering dependencies by 50%.",
      "Zero-Downtime Migrations: Wrote resilient Node.js scripts to upgrade 8 core ecosystem microservices from v4.x to v5.x, successfully onboarding 15+ enterprise clients with zero data loss or service degradation.",
    ],
